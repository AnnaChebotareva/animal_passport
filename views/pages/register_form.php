                ...
                <form id="registerForm" action="controllers/RegisterController.php" method="POST"
                        ...
                        <div class="mb-4">
                            ...
                            <div id="additionalPhotosContainer">
                                ...
                                <div class="input-group mb-2">
                                    <input type="file" class="form-control additional-photo" name="additional_photos[]"
                    ...
                    <div class="mb-5">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control" id="owner_phone" name="owner_phone"
                                    placeholder="+7 (999) 123-45-67" pattern="\d{11}" maxlength="11" data-length="11"
                                    required>
                                <div class="invalid-feedback">Введите 11-значный номер телефона (только цифры)</div>
                                <div class="valid-feedback">Номер телефона введен корректно</div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="email" class="form-control" id="owner_email" name="owner_email"
                                    ...
                                    title="Введите корректный email адрес (пример: example@mail.ru)" required>
                                <div class="form-text">
                                    <small>Email должен содержать символ @ и домен (.ru, .com, .net и т.д.)</small>
                                </div>
                                <div class="invalid-feedback">
                                    Введите корректный email адрес (пример: ivanov@mail.ru)
                                </div>
                        ...
                        <div class="alert alert-secondary mt-3">
                            <h6><i class="bi bi-info-circle"></i> Важно:</h6>
                            <p class="mb-0">
                                Если вы уже регистрировали животных в нашей системе ранее, введите те же данные
                                владельца
                                (email или телефон). Система автоматически добавит нового питомца к вашему существующему
                                аккаунту.
                            </p>
                        </div>
                    </div>
